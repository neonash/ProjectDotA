...
//                data1['tagdict'].push($(this).val());
////                    data1['tagdict'].push("C:\\Users\\akshat.gupta\\PycharmProjects\\dota_analytics\\mysite\\dota_analytics\\database\\TaggingDicts\\electronics_dict.csv");
//                }
//                else if($(this).id == 'chkBoxDictDS'){
//                data1['tagdict'].push($(this).val());
////                    data1['tagdict'].push("C:\\Users\\akshat.gupta\\PycharmProjects\\dota_analytics\\mysite\\dota_analytics\\database\\TaggingDicts\\RB_supplements_dictionary_2903.csv");
//                }
